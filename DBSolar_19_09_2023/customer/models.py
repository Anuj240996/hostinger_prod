...
class Customer(models.Model):
    ...
    Emp_id = models.ForeignKey(User, on_delete=models.CASCADE, db_column='emp_id_id')
    state = models.CharField(max_length=100, null=True)
    Pincode = models.IntegerField(default=0, db_column='pincode')
...
class customer_technical_Details(models.Model):
        ...
        AssignTo = models.ForeignKey(User, related_name='assign_to', on_delete=models.SET_NULL, null=True, db_column='assignto_id')
        AssignBy = models.ForeignKey(User, related_name='assign_by', on_delete=models.SET_NULL, null=True, db_column='assignby_id')
...
class Meter(models.Model):
   ...
   #  generation_ct_serial = models.CharField(max_length=100)
    Comp_name = models.CharField(max_length=255, db_column='comp_name')
...
class Meters(models.Model):
    ...
    AssignBy = models.ForeignKey(User, related_name='meters_assigned_by', on_delete=models.SET_NULL, null=True, db_column='assignby_id')
...
class GenerationMeter(models.Model):
    ...
    capacity = models.CharField(max_length=50)
    serial_no = models.CharField(max_length=20)
    CT_make = models.CharField(max_length=100, null=True, db_column='ct_make')
    CT_capacity = models.CharField(max_length=50, null=True, db_column='ct_capacity')
    CT_serial_no = models.CharField(max_length=20, null=True, db_column='ct_serial_no')
    AssignBy = models.ForeignKey(User, related_name='generation_meters_assigned_by', on_delete=models.SET_NULL, null=True, db_column='assignby_id')
...
class MSEB(models.Model):
    ...
    AssignBy = models.ForeignKey(User, related_name='MSEB_assigned_by', on_delete=models.SET_NULL, null=True, db_column='assignby_id')
...
class SolarPump(models.Model):
    ...
    AssignTo = models.ForeignKey(User, on_delete=models.CASCADE, null=True, related_name='consumer', db_column='assignto_id')
    AssignBy = models.ForeignKey(User, on_delete=models.CASCADE, null=True, related_name='fillup_By', db_column='assignby_id')
...
class Controller(models.Model):
    ...
    AssignTo = models.ForeignKey(User, on_delete=models.CASCADE, null=True, related_name='consumer_controller', db_column='assignto_id')
    AssignBy = models.ForeignKey(User, on_delete=models.CASCADE, null=True, related_name='fillup_By_controller', db_column='assignby_id')
...
class Result(models.Model):
    ...
    AssignTo = models.ForeignKey(User, on_delete=models.CASCADE, null=True, related_name='consumer_userid', db_column='assignto_id')
