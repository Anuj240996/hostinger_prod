...
urlpatterns = [
    ...
    path('complaints/send-action-otp/<int:pid>', complaintSendActionOtp, name='firereport-complaint-send-action-otp'),
    path('complaints/verify-action-otp/<int:pid>', complaintVerifyActionOtp, name='firereport-complaint-verify-action-otp'),
    ...
    path('services/send-otp/<int:pid>', serviceSendReportOtp, name='firereport-service-send-otp'),
    path('services/verify-otp/<int:pid>', serviceVerifyReportOtp, name='firereport-service-verify-otp'),
