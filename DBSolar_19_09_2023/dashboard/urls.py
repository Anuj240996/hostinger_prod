...
urlpatterns = [
    ...
    path('notification/open/<int:pk>/', views.open_staff_notification, name='dashboard-open-notification'),
    path('notification/api/open/<int:pk>/', views.staff_notification_open_api, name='dashboard-open-notification-api'),
    path('notification/api/mark-all-read/', views.staff_notification_mark_all_api, name='dashboard-mark-all-notifications-api'),
    path('notification/mark-all-read/', views.mark_all_staff_notifications_read, name='dashboard-mark-all-notifications-read'),
